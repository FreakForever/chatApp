    ...
    return (
        <div className="flex flex-col min-h-screen bg-black text-gray-100">
            <div className="flex-grow mt-28">
                <h1 className="text-5xl font-bold mb-12 text-center text-gray-200">About Us</h1>
                ...
                <section className="max-w-5xl mx-auto px-6 mb-12 bg-gray-900 p-8 rounded-lg shadow-lg text-center">
                    <h2 className="text-4xl font-semibold mb-6 text-gray-200">Core Values</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {[
                            ...
                            <div key={index} className="bg-gray-800 p-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                                <h3 className="text-xl font-semibold mb-3 text-gray-200">{value.title}</h3>
            ...
            <footer className="bg-gray-900 w-full text-center p-4">
                <p className="text-sm text-gray-300">&copy; 2024 ChatPlatform. All rights reserved.</p>
            </footer>
        </div>
    );
};
