...
const Home = () => {
    ...
    return (
        <div className="h-screen bg-gray-900 text-white mt-10">
            {/* Main Content */}
            <div className="flex flex-col justify-center items-center h-[40%] px-4 sm:px-8 mt-10">
                <h1 className="text-3xl sm:text-5xl font-bold mb-4 sm:mb-6 hover:text-violet-400 transition-colors duration-300 transform hover:scale-105 mt-10">
                    Welcome to Stranger Chat! 🎉
                </h1>
                <p className="text-base sm:text-lg text-center max-w-2xl mb-4 sm:mb-8 hover:text-pink-400 transition-colors duration-300 transform hover:scale-105">
                ...
                <button
                    ...
                    className="bg-gray-300 text-black px-4 sm:px-6 py-2 sm:py-3 rounded-full border border-gray-500 shadow-lg hover:bg-violet-400 hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                >
                    💬 Start Chatting
                </button>
            </div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black flex justify-center items-center bg-opacity-50 z-50">
                    <div className="bg-violet-800 p-4 sm:p-6 rounded-lg shadow-lg text-white border border-gray-700">
            ...
            {/* Features Section */}
            <div className="bg-gray-800 text-white py-12 sm:py-16 px-6 sm:px-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8 hover:text-violet-400 transition-colors duration-300">✨ Features</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    {["Anonymous Chatting 🤐", "Real-time Messaging ⚡", "Match with New People 🌍", "Secure Connections 🔒", "Easy to Use Interface 📱", "Mobile-Friendly 📲"].map((feature, index) => (
                        <div key={index} className="bg-gray-700 p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg border border-gray-600 transition-all duration-300 transform hover:scale-105">
                            <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 hover:text-yellow-300">{feature}</h3>
            ...
            <div className="bg-gray-900 text-white py-12 sm:py-16 px-6 sm:px-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8 hover:text-violet-400 transition-colors duration-300">🔍 How It Works</h2>
                <div className="flex flex-col sm:flex-row sm:justify-between items-center sm:items-start gap-6 sm:gap-8">
                    {[1, 2, 3].map(step => (
                        <div key={step} className="bg-gray-700 p-4 sm:p-6 rounded-lg shadow-md border border-gray-600 hover:shadow-lg transition-all duration-300 text-center transform hover:scale-105">
                            <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 hover:text-green-300">Step {step}</h3>
            ...
            <div className="bg-gray-800 text-white py-12 sm:py-16 px-6 sm:px-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8 hover:text-violet-400 transition-colors duration-300">💬 What People Are Saying</h2>
                <div className="flex flex-col sm:flex-row sm:justify-between items-center sm:items-start gap-6 sm:gap-8">
                    {["Jane Doe", "John Smith", "Emily Lee"].map((name, index) => (
                        <div key={index} className="text-center hover:bg-gray-700 p-4 sm:p-6 rounded-lg shadow-md transition-all duration-300 bg-gray-600 transform hover:scale-105">
            ...
            <div className="bg-gray-900 text-white py-12 sm:py-16 px-6 sm:px-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8 hover:text-violet-400 transition-colors duration-300">💡 How This Can Help with User Stress</h2>
                <div className="flex flex-col sm:flex-row sm:justify-between items-center sm:items-start gap-6 sm:gap-8">
                    {["Express Yourself 💬", "Connect with Others 🤝", "Anonymous Support 🤫"].map((benefit, index) => (
                        <div key={index} className="bg-gray-700 p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg border border-gray-600 text-center transition-all duration-300 transform hover:scale-105">
                            <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 hover:text-blue-300">{benefit}</h3>
                            <p className="text-sm sm:text-base">
